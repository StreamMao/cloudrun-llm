...
# Download the Qwen3-4B Q4_K_M GGUF model (~2.5GB)
ADD https://huggingface.co/bartowski/Qwen_Qwen3-4B-GGUF/resolve/main/Qwen3-4B-Q4_K_M.gguf /models/model.gguf
